...
inherits_browser(Changes$1, events.EventEmitter);
...
inherits_browser(AbstractPouchDB, events.EventEmitter);
  ...
  api._changes = function (opts) {
    ...
    var fetched = function (err, res) {
      ...
      if ((opts.continuous && !(limit && leftToFetch <= 0)) || !finished) {
        ...
        browser(function () { fetchData(lastFetchedSeq, fetched); });
      } else {
...
inherits_browser(Replication, events.EventEmitter);
...
inherits_browser(Sync, events.EventEmitter);
